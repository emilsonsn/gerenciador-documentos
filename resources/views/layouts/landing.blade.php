                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s">{{__('DRMS SaaS - Digital Record Management System')}}</h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s">{{__('Document and Records Management System (DRMS SaaS) software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')}}</p>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Dashboard')}}</h5>
                                    <p>{{__('DRMS SaaS software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        ...
                        <ul class="cdxprice-list">
                            ...
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->document_limit}}</span>{{__('Document Limit')}}</li>
