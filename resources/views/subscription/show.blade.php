...
@push('script-page')
    ...
    <script>
        @if ($settings['flutterwave_payment'] == 'on' && !empty($settings['flutterwave_public_key']) && !empty($settings['flutterwave_secret_key']))
                ...
                if (amount) {
                    var flutterwavePayment = getpaidSetup({
                        ...
                        callback: function(result) {
                            ...
                            var redirectUrl=flutterwaveCallbackURL + '/' + '{{ \Illuminate\Support\Facades\Crypt::encrypt($subscription->id) }}' +
                                    '/' + txRef;
