                ...
                <div class="card-body">
                    <div class="info-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('phone_number',__('Whatsapp'),array('class'=>'form-label'))); ?>

                                    <?php echo e(Form::text('phone_number',null,array('class'=>'form-control','placeholder'=>__('Digite seu whatsapp'),'required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emilsonsn/desktop/Emilson/Projetos/9 - Setembro/geradoc-master/main_file/resources/views/settings/account.blade.php ENDPATH**/ ?>